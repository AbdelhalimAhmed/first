...
module.exports = React.createClass({
    ...
    fetchData: function (userIdNavigator) {
        var API_URL = 'http://jsonplaceholder.typicode.com/albums?userId='+userIdNavigator;
     ...
     renderRow: function(rowData) {
        return (
                    ...
                    <View style = {styles.rowContainer1}>
                        <Button text={rowData.title} onPress = {() => this.onAlbumPress(rowData.id)}/>
                     </View>
